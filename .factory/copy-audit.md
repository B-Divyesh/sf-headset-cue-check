...
| Copy | Words | Result |
| --- | ---: | --- |
| Complete the check in three steps | 6 | Pass |
| Select the headset | 3 | Pass |
| Choose it in your operating system. | 6 | Pass |
| Begin at a low volume. | 5 | Pass |
| Play and rate six cues | 5 | Pass |
| Record what you notice about speech, channels, levels, and alerts. | 10 | Pass |
| Save the settings | 3 | Pass |
| Keep a local setup card you can repeat later. | 9 | Pass |
| Saved setup cards | 3 | Pass |
| No setup cards yet. | 4 | Pass |
...
| Changes stay separate from your setup cards. | 7 | Pass |
| Reset demo | 2 | Pass |
| Start for real | 3 | Pass |
| Start a sample check | 4 | Pass |

## Terminology

| Concept | One term used |
| --- | --- |
| The six-step activity | check |
| One listening step | observation |
| A sound played by the app | cue |
| The saved result | setup card |
| Temporary seeded experience | demo |
| Real user storage | setup cards |
